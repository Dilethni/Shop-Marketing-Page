...
<div className="space-y-4">
  ...
  {/* Location */}
  <a href="https://maps.app.goo.gl/nVDpuQvgZsS8MErY6?g_st=ipc" target="_blank" rel="noopener noreferrer" className="flex gap-4">
    <div className="w-10 h-10 bg-[#00572B] rounded-lg flex items-center justify-center shrink-0">
  ...
  {/* Phone */}
  <a href="tel:+94716003410" className="flex gap-4">
    <div className="w-10 h-10 bg-[#00572B] rounded-lg flex items-center justify-center shrink-0">
  ...
  {/* Email */}
  <a href="ascmatara@gmail.com" className="flex gap-4">
    <div className="w-10 h-10 bg-[#00572B] rounded-lg flex items-center justify-center shrink-0">
